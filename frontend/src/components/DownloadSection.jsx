...
const DownloadSection = () => {
  const handleDownload = (platform) => {
    // Link ke Play Store (sama untuk kedua platform sementara)
    window.open('https://play.google.com/store/apps/details?id=ngi.muchi.koetaradja&hl=id&pli=1', '_blank');
  };

  return (
    <section id="download" className="py-20 bg-gradient-to-br from-emerald-600 via-emerald-700 to-green-700 text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
                Pantau Bus Real-Time dengan Aplikasi Trans Koetaradja
              </h2>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100">Lacak posisi bus secara real-time di peta</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100">Lihat jadwal lengkap dan estimasi waktu tiba</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100">Terima update penting tentang layanan</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button
                  ...
                  className="bg-white text-emerald-700 hover:bg-gray-100 px-8 py-6 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3"
                >
                ...
                <Button
                  ...
                  className="bg-white/10 backdrop-blur-sm border-2 border-white text-white hover:bg-white hover:text-emerald-700 px-8 py-6 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3"
                >
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p className="text-sm text-emerald-100 pt-2">
                  ...
                  <div className="bg-gray-900 rounded-[3rem] p-3 shadow-2xl">
                    <div className="bg-white rounded-[2.5rem] overflow-hidden">
                      ...
                      <div className="relative h-[560px]">
                        {/* Status bar */}
                        <div className="absolute top-0 left-0 right-0 h-8 bg-emerald-600 flex items-center justify-between px-6 text-white text-xs">
                          <span>9:41</span>
                          <span>⚡ 100%</span>
                        </div>
                        {/* App Content */}
                        <div className="pt-8 px-4 bg-gradient-to-b from-emerald-600 to-emerald-500 h-full">
                          <div className="bg-white rounded-2xl p-4 mb-4 shadow-lg">
                            ...
                            <p className="text-xs text-gray-600">Lacak bus Anda secara real-time</p>
                          </div>
